...
bool RequestContextSlab::Initialize() {
  pre_allocate_context_num_ =
      ClientConfig::GetContextSlabOption().pre_allocate_context_num;
...
IOTrackerSlab::IOTrackerSlab() : waitinflightio_(false), inflightio_(0) {}
