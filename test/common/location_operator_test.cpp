...
TEST(LocationOperatorTest, ParseCurvePathTest) {
  ...
  originPath = "test";
  ASSERT_EQ(false, LocationOperator::ParseCurveChunkPath(originPath, &fileName,
                                                         &offset));
  ...
  originPath = "test:0";
  ASSERT_EQ(true, LocationOperator::ParseCurveChunkPath(originPath, &fileName,
                                                        &offset));
  ...
  originPath = "test:0";
  ASSERT_EQ(true, LocationOperator::ParseCurveChunkPath(originPath, nullptr,
                                                        nullptr));
}
