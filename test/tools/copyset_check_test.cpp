...
class CopysetCheckTest : public ::testing::Test {
 protected:
  ...
  void GetIoBufForTest(butil::IOBuf* buf, const std::string& gId,
                       ...
                       bool installingSnapshot = false, bool peersLess = false,
                       bool gapBig = false, bool parseErr = false,
...
TEST_F(CopysetCheckTest, CheckOneCopyset) {
  ...
  std::vector<std::string> peersInCopyset = {"127.0.0.1:9091", "127.0.0.1:9092",
                                             "127.0.0.1:9093"};
