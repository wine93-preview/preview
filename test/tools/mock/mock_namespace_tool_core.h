...
class MockNameSpaceToolCore : public NameSpaceToolCore {
 public:
  MockNameSpaceToolCore() : NameSpaceToolCore(std::make_shared<MDSClient>()) {}
  ...
  MOCK_METHOD2(GetFileSegments,
               int(const std::string&, std::vector<PageFileSegment>*));
  MOCK_METHOD4(QueryChunkCopyset, int(const std::string&, uint64_t, uint64_t*,
