 ...
 public:
  MOCK_METHOD4(RegistChunkServer,
               void(RpcController* controller,
                    ...
                    ChunkServerRegistResponse* response, Closure* done));
  MOCK_METHOD4(ListChunkServer,
               void(RpcController* controller,
                    const ListChunkServerRequest* request,
                    ListChunkServerResponse* response, Closure* done));
  MOCK_METHOD4(GetChunkServer,
               void(RpcController* controller,
                    const GetChunkServerInfoRequest* request,
                    GetChunkServerInfoResponse* response, Closure* done));
  MOCK_METHOD4(DeleteChunkServer,
               void(RpcController* controller,
                    const DeleteChunkServerRequest* request,
                    DeleteChunkServerResponse* response, Closure* done));
  MOCK_METHOD4(SetChunkServer,
               void(RpcController* controller,
                    const SetChunkServerStatusRequest* request,
                    SetChunkServerStatusResponse* response, Closure* done));
  MOCK_METHOD4(RegistServer,
               void(RpcController* controller,
                    const ServerRegistRequest* request,
                    ServerRegistResponse* response, Closure* done));
  MOCK_METHOD4(GetServer,
               void(RpcController* controller, const GetServerRequest* request,
                    GetServerResponse* response, Closure* done));
  MOCK_METHOD4(DeleteServer,
               void(RpcController* controller,
                    const DeleteServerRequest* request,
                    DeleteServerResponse* response, Closure* done));
  MOCK_METHOD4(ListZoneServer,
               void(RpcController* controller,
                    const ListZoneServerRequest* request,
                    ListZoneServerResponse* response, Closure* done));
  MOCK_METHOD4(CreateZone,
               void(RpcController* controller, const ZoneRequest* request,
                    ZoneResponse* response, Closure* done));
  ...
  MOCK_METHOD4(ListPoolZone,
               void(RpcController* controller,
                    ...
                    ListPoolZoneResponse* response, Closure* done));
  MOCK_METHOD4(CreatePhysicalPool,
               void(RpcController* controller,
                    const PhysicalPoolRequest* request,
                    PhysicalPoolResponse* response, Closure* done));
  ...
  MOCK_METHOD4(CreateLogicalPool,
               void(RpcController* controller,
                    ...
                    CreateLogicalPoolResponse* response, Closure* done));
  MOCK_METHOD4(DeleteLogicalPool,
               void(RpcController* controller,
                    const DeleteLogicalPoolRequest* request,
                    DeleteLogicalPoolResponse* response, Closure* done));
  MOCK_METHOD4(GetLogicalPool,
               void(RpcController* controller,
                    const GetLogicalPoolRequest* request,
                    GetLogicalPoolResponse* response, Closure* done));
  ...
  MOCK_METHOD4(SetLogicalPoolScanState,
               void(RpcController* controller,
                    ...
                    SetLogicalPoolScanStateResponse* response, Closure* done));
  ...
  MOCK_METHOD4(GetCopyset,
               void(RpcController* controller, const GetCopysetRequest* request,
                    GetCopysetResponse* response, Closure* done));

  MOCK_METHOD4(GetClusterInfo,
               void(RpcController* controller,
                    const GetClusterInfoRequest* request,
                    GetClusterInfoResponse* response, Closure* done));
