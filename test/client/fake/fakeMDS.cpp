...
FakeMDS::FakeMDS(std::string filename) { filename_ = filename; }
...
bool FakeMDS::StartService() {
  ...
  ::curve::mds::CreateFileResponse* createfileresponse =
      new ::curve::mds::CreateFileResponse();  // NOLINT
  createfileresponse->set_statuscode(::curve::mds::StatusCode::kOK);
  FakeReturn* fakcreatefileeret = new FakeReturn(
      nullptr, static_cast<void*>(createfileresponse));  // NOLINT
  ...
  ::curve::mds::GetFileInfoResponse* getfileinforesponse =
      new ::curve::mds::GetFileInfoResponse();  // NOLINT
  ...
  FakeReturn* fakeGetFileInforet = new FakeReturn(
      nullptr, static_cast<void*>(getfileinforesponse));  // NOLINT
  fakecurvefsservice_.SetGetFileInfoFakeReturn(fakeGetFileInforet);

  // set DeAllocateSegment fake return
  auto* deAllocateSegmentResponse = new curve::mds::DeAllocateSegmentResponse();
  ...
  fakecurvefsservice_.SetDeAllocateSegmentFakeReturn(deAllocateSegmentFakeRet);

  /**
   * set GetOrAllocateSegment fake return
   */
  curve::mds::GetOrAllocateSegmentResponse* getallocateresponse =
      new curve::mds::GetOrAllocateSegmentResponse();  // NOLINT
  ...
  getallocateresponse->mutable_pagefilesegment()->set_segmentsize(
      segment_size);  // NOLINT
  ...
  for (unsigned i = 1; i <= chunknum; i++) {
    auto chunk =
        getallocateresponse->mutable_pagefilesegment()->add_chunks();  // NOLINT
    chunk->set_copysetid(i % FLAGS_copyset_num);
    chunk->set_chunkid(i);
  }
  FakeReturn* fakeret = new FakeReturn(
      nullptr, static_cast<void*>(getallocateresponse));  // NOLINT
  ...
  GetChunkServerListInCopySetsResponse* getserverlistresponse =
      new GetChunkServerListInCopySetsResponse();  // NOLINT
  ...
  FakeReturn* faktopologyeret = new FakeReturn(
      nullptr, static_cast<void*>(getserverlistresponse));  // NOLINT
  ...
  FakeReturn* openfakeret =
      new FakeReturn(nullptr, static_cast<void*>(openresponse));  // NOLINT
  ...
  ::curve::mds::ReFreshSessionResponse* refreshresp =
      new ::curve::mds::ReFreshSessionResponse();  // NOLINT
  ...
  FakeReturn* refreshfakeret =
      new FakeReturn(nullptr, static_cast<void*>(refreshresp));  // NOLINT
  ...
  ::curve::mds::CreateSnapShotResponse* response =
      new ::curve::mds::CreateSnapShotResponse();  // NOLINT
  ...
  ::curve::mds::ListSnapShotFileInfoResponse* listresponse =
      new ::curve::mds::ListSnapShotFileInfoResponse;  // NOLINT
  ...
  FakeReturn* listfakeret =
      new FakeReturn(nullptr, static_cast<void*>(listresponse));  // NOLINT
  fakecurvefsservice_.SetListSnapShot(listfakeret);

  /**
   * set get snap allocate info
   */
  // FakeReturn* snapfakeret = new FakeReturn(nullptr,
  // static_cast<void*>(getallocateresponse));      // NOLINT
  ...
  ::curve::mds::DeleteSnapShotResponse* delresponse =
      new ::curve::mds::DeleteSnapShotResponse;  // NOLINT
  delresponse->set_statuscode(::curve::mds::StatusCode::kOK);
  FakeReturn* delfakeret =
      new FakeReturn(nullptr, static_cast<void*>(delresponse));  // NOLINT
...
void FakeMDS::CreateFakeChunkservers(bool enablecli) {
  for (unsigned i = 0; i < peers_.size(); i++) {
    ...
    if (enablecli &&
        chunkservers_[i]->AddService(&fakeCliService_,
                                     brpc::SERVER_DOESNT_OWN_SERVICE) != 0) {
      LOG(FATAL) << "Fail to add service";
    }
