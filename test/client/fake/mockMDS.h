...
class FakeCurveFSService : public curve::mds::CurveFSService {
 public:
  ...
  void CreateFile(::google::protobuf::RpcController* controller,
    ...
    auto resp =
        static_cast<::curve::mds::CreateFileResponse*>(fakeret_->response_);
  ...
  void GetFileInfo(::google::protobuf::RpcController* controller,
    ...
    auto resp =
        static_cast<::curve::mds::GetFileInfoResponse*>(fakeret_->response_);
    response->CopyFrom(*resp);
  }
 ...
 public:
  ...
  void GetChunkServer(
    ...
    if (getcsfakeret_->controller_ != nullptr &&
      ...
      auto cntl = static_cast<brpc::Controller*>(getcsfakeret_->controller_);
      auto brpccntl = static_cast<brpc::Controller*>(controller);
      brpccntl->SetFailed(cntl->ErrorCode(), "failed");
    }
    ...
    auto resp = static_cast<curve::mds::topology::GetChunkServerInfoResponse*>(
...
class FakeCliService : public curve::chunkserver::CliService2 {
 public:
  ...
  int GetInvokeTimes() { return invoketimes_; }

  void CleanInvokeTimes() { invoketimes_ = 0; }

  void SetFakeReturn(FakeReturn* fakeret) { fakeret_ = fakeret; }

  void SetDelayMs(uint64_t waitMs) { waitMs_ = waitMs; }

  void ClearDelay() { waitMs_ = 0; }

  void SetErrorCode(int errCode) { errCode_ = errCode; }

  void ClearErrorCode() { errCode_ = 0; }
