...
TEST(MetricTest, SuspendRPC_MetricTest) {
  ...
  opt.ioOpt.reqSchdulerOpt.ioSenderOpt.failRequestOpt.chunkserverOPMaxRetry =
      50;
  opt.ioOpt.reqSchdulerOpt.ioSenderOpt.failRequestOpt.chunkserverRPCTimeoutMS =
      50;
  opt.ioOpt.reqSchdulerOpt.ioSenderOpt.failRequestOpt
      .chunkserverMaxRPCTimeoutMS = 50;
