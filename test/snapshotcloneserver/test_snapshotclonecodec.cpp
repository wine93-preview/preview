...
TEST(TestSnapshotCloneServerCodec, TestSnapInfoEncodeDecodeEqual) {
  SnapshotInfo snapInfo("snapuuid", "snapuser", "file1", "snapxxx", 100, 1024,
                        2048, 4096, 4096, 8, 0, Status::pending);
...
TEST(TestSnapshotCloneServerCodec, TestCloneInfoEncodeDecodeEqual) {
  CloneInfo cloneInfo("cloneuuid", "cloneuser", CloneTaskType::kRecover,
                      "srcfile", "dstfile", 1, 2, 3, CloneFileType::kSnapshot,
                      false, CloneStep::kCompleteCloneFile,
