...
class MockStorage : public TopologyStorage {
 public:
  ...
  MOCK_METHOD4(init, bool(const std::string& dbName, const std::string& user,
  ...
  MOCK_METHOD2(LoadCopySet,
               bool(std::map<CopySetKey, ::curve::mds::topology::CopySetInfo>*
                        copySetMap,
  ...
  MOCK_METHOD1(StorageCopySet,
               bool(const ::curve::mds::topology::CopySetInfo& data));
