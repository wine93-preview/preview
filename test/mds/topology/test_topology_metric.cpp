...
class TestTopologyMetric : public ::testing::Test {
 public:
  ...
  void SetUp() {
    ...
    testObj_ = std::make_shared<TopologyMetricService>(topology_, topologyStat_,
                                                       allocStatistic_);
  }
...
TEST_F(TestTopologyMetric, TestUpdateTopologyMetricsOneLogicalPool) {
  ...
  PrepareAddLogicalPool(logicalPoolId, "logicalPool1", physicalPoolId, PAGEFILE,
                        rap);
  ...
  ASSERT_EQ(1024, gChunkServerMetrics[0x41]->chunkSizeTrashedBytes.get_value());
  ASSERT_EQ(1024 * 3,
  ...
  ASSERT_EQ(1024, gChunkServerMetrics[0x42]->chunkSizeTrashedBytes.get_value());
  ASSERT_EQ(1024 * 3,
  ...
  ASSERT_EQ(1024, gChunkServerMetrics[0x43]->chunkSizeTrashedBytes.get_value());
  ASSERT_EQ(1024 * 3,
            gChunkServerMetrics[0x43]->chunkSizeTotalBytes.get_value());

  ASSERT_EQ(1, gLogicalPoolMetrics.size());
  ASSERT_EQ(
      3, gLogicalPoolMetrics[logicalPoolId]->serverNum.get_value());  // NOLINT
  ASSERT_EQ(3, gLogicalPoolMetrics[logicalPoolId]
                   ->chunkServerNum.get_value());  // NOLINT
  ASSERT_EQ(
      1, gLogicalPoolMetrics[logicalPoolId]->copysetNum.get_value());  // NOLINT
  ...
  ASSERT_EQ(
      1,
      gLogicalPoolMetrics[logicalPoolId]->copysetNumAvg.get_value());  // NOLINT
  ASSERT_EQ(0, gLogicalPoolMetrics[logicalPoolId]
  ...
  ASSERT_EQ(
      1,
      gLogicalPoolMetrics[logicalPoolId]->copysetNumMin.get_value());  // NOLINT
  ASSERT_EQ(
      1,
      gLogicalPoolMetrics[logicalPoolId]->copysetNumMax.get_value());  // NOLINT
  ASSERT_EQ(
      0,
      gLogicalPoolMetrics[logicalPoolId]->leaderNumAvg.get_value());  // NOLINT
  ASSERT_EQ(0, gLogicalPoolMetrics[logicalPoolId]
  ...
  ASSERT_EQ(
      0,
      gLogicalPoolMetrics[logicalPoolId]->leaderNumMin.get_value());  // NOLINT
  ASSERT_EQ(
      0,
      gLogicalPoolMetrics[logicalPoolId]->leaderNumMax.get_value());  // NOLINT
  ASSERT_EQ(
      100 * 1024 * 3,
      gLogicalPoolMetrics[logicalPoolId]->diskCapacity.get_value());  // NOLINT
  ASSERT_EQ(
      20 * 1024 * 3,
