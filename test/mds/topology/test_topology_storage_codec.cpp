...
TEST(TestTopologyStorageCodec, TestLogicalPoolEncodeDecodeEqual) {
  ...
  LogicalPool data(0x11, "lpool", 0x21, LogicalPoolType::PAGEFILE, rap, policy,
                   100, true, true);
...
TEST(TestTopologyStorageCodec, TestPhysicalPoolEncodeDecodeEqual) {
...
TEST(TestTopologyStorageCodec, TestZoneEncodeDecodeEqual) {
...
TEST(TestTopologyStorageCodec, TestServerEncodeDecodeEqual) {
...
TEST(TestTopologyStorageCodec, TestChunkServerEncodeDecodeEqual) {
  ChunkServer data(0x51, "token", "ssd", 0x41, "127.0.0.1", 8080, "/root",
                   ChunkServerStatus::READWRITE, OnlineState::OFFLINE);
...
TEST(TestTopologyStorageCodec, TestCopySetInfoEncodeDecodeEqual) {
...
TEST(TestTopologyStorageCodec, TestClusterInfoEncodeDecodeEqual) {
...
TEST(TestTopologyStorageCodec, TestEncodeKeyNotEqual) {
  TopologyStorageCodec testObj;
