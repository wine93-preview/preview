...
class MockStorage : public TopologyStorage {
 public:
  ...
  MOCK_METHOD2(LoadLogicalPool,
               bool(std::unordered_map<PoolIdType, LogicalPool>* logicalPoolMap,
                    PoolIdType* maxLogicalPoolId));
  MOCK_METHOD2(
      LoadPhysicalPool,
      bool(std::unordered_map<PoolIdType, PhysicalPool>* physicalPoolMap,
  ...
  MOCK_METHOD2(
      LoadChunkServer,
      bool(std::unordered_map<ChunkServerIdType, ChunkServer>* chunkServerMap,
...
class MockChunkServerRegistInfoBuilder : public ChunkServerRegistInfoBuilder {
 public:
  MOCK_METHOD1(
      BuildEpochMap,
      int(::google::protobuf::Map<::google::protobuf::uint64,
...
class MockTopologyServiceManager : public TopologyServiceManager {
 public:
  MockTopologyServiceManager(
      ...
      std::shared_ptr<curve::mds::copyset::CopysetManager>
          copysetManager)  // NOLINT
      : TopologyServiceManager(topology, topologyStat, nullptr, copysetManager,
                               nullptr) {}
  ...
  MOCK_METHOD2(GetChunkServerInCluster,
               void(const GetChunkServerInClusterRequest* request,
  ...
  MOCK_METHOD2(CreateZone,
               void(const ZoneRequest* request, ZoneResponse* response));

  MOCK_METHOD2(DeleteZone,
               void(const ZoneRequest* request, ZoneResponse* response));

  MOCK_METHOD2(GetZone,
               void(const ZoneRequest* request, ZoneResponse* response));
  ...
  MOCK_METHOD2(GetChunkServerListInCopySets,
               void(const GetChunkServerListInCopySetsRequest* request,
                    GetChunkServerListInCopySetsResponse* response));

  MOCK_METHOD2(GetCopySetsInChunkServer,
               void(const GetCopySetsInChunkServerRequest* request,
  ...
  MOCK_METHOD2(GetClusterInfo, void(const GetClusterInfoRequest* request,
                                    GetClusterInfoResponse* response));

  MOCK_METHOD2(SetCopysetsAvailFlag, void(const SetCopysetsAvailFlagRequest*,
                                          SetCopysetsAvailFlagResponse*));

  MOCK_METHOD2(ListUnAvailCopySets, void(const ListUnAvailCopySetsRequest*,
...
class MockTopologyServiceImpl : public TopologyService {
 public:
  ...
  MOCK_METHOD4(RegistServer, void(google::protobuf::RpcController* cntl_base,
  ...
  MOCK_METHOD4(CreateZone,
               void(google::protobuf::RpcController* cntl_base,
                    const ZoneRequest* request, ZoneResponse* response,
                    google::protobuf::Closure* done));
