...
class BitmapAllocator : public Allocator {
 ...
 private:
  ...
  uint64_t AllocInternal(const AllocOrder& order, const uint64_t size,
                         const AllocateHint& hint, std::vector<Extent>* exts);

  // allocate staffs
  uint64_t AllocFromBitmap(const uint64_t size, const AllocateHint& hint,
                           std::vector<Extent>* exts);
  uint64_t AllocFromBitmapExtent(const uint64_t size, const AllocateHint& hint,
                                 std::vector<Extent>* exts);
  uint64_t AllocFromSmallExtent(const uint64_t size, const AllocateHint& hint,
                                std::vector<Extent>* exts);
  ...
  void Split(const uint64_t off, const uint64_t len, uint64_t* offInSmallExtent,
