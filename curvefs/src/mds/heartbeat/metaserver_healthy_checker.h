...
struct HeartbeatInfo {
  ...
  HeartbeatInfo(MetaServerIdType id, const steady_clock::time_point& time,
...
class MetaserverHealthyChecker {
 public:
  MetaserverHealthyChecker(HeartbeatOption option,
 ...
 private:
  bool MetaServerStateNeedUpdate(const HeartbeatInfo& info,
                                 OnlineState* newState);

  void UpdateMetaServerOnlineState(MetaServerIdType id,
