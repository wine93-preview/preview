...
#ifndef CURVEFS_SRC_MDS_SCHEDULE_OPERATORTEMPLATE_H_
#define CURVEFS_SRC_MDS_SCHEDULE_OPERATORTEMPLATE_H_
...
class OperatorT {
 ...
 public:
  OperatorT() = default;
  OperatorT(EpochType startEpoch, const CopySetKey& id, OperatorPriority pri,
   ...
   */
  ApplyStatus Apply(const CopySetInfoT& originInfo, CopySetConfT* newInfo);
...
template <class IdType, class CopySetInfoT, class CopySetConfT>
std::vector<IdType>
OperatorT<IdType, CopySetInfoT, CopySetConfT>::AffectedChunkServers() const {
...
template <class IdType, class CopySetInfoT, class CopySetConfT>
std::string OperatorT<IdType, CopySetInfoT, CopySetConfT>::OpToString() const {
  return "[startEpoch: " + std::to_string(startEpoch) + ", copysetID: (" +
         std::to_string(copysetID.first) + "," +
         std::to_string(copysetID.second) +
         "), priority: " + std::to_string(priority) +
         ", step: " + step->OperatorStepToString() + "]";
}
}  // namespace schedule
}  // namespace mds
}  // namespace curvefs
#endif  // CURVEFS_SRC_MDS_SCHEDULE_OPERATORTEMPLATE_H_
