 ...
 *   2: kEnableTimeAndCPUTimeExceptForMutex  // Other than count stats, also
 * enable time
 *                                           // stats except for mutexes
 *                                           // Other than time, also measure
 * CPU time counters. Still don't measure
 *                                           // time (neither wall time nor CPU
 * time) for mutexes. 3: kEnableTimeExceptForMutex 4: kEnableTime // enable
 * count and time stats see also:
 * https://github.com/facebook/rocksdb/wiki/Perf-Context-and-IO-Stats-Context#profile-levels-and-costs
 *
