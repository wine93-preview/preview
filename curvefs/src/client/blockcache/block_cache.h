...
class BlockCacheImpl : public BlockCache {
 ...
 private:
  ...
  void Upload(const BlockKey& key, const Block& block);
 ...
 private:
  ...
  std::unique_ptr<StageBlockCount> staging_;
};

S3ClientImpl& BlockCacheImpl::S3Client() { return S3ClientImpl::GetInstance(); }
