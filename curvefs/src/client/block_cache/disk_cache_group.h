...
#ifndef CURVEFS_SRC_CLIENT_BLOCK_CACHE_DISK_CACHE_GROUP_H_
#define CURVEFS_SRC_CLIENT_BLOCK_CACHE_DISK_CACHE_GROUP_H_
...
#endif  // CURVEFS_SRC_CLIENT_BLOCK_CACHE_DISK_CACHE_GROUP_H_
