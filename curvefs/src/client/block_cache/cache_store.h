...
#ifndef CURVEFS_SRC_CLIENT_BLOCK_CACHE_CACHE_STORE_H_
#define CURVEFS_SRC_CLIENT_BLOCK_CACHE_CACHE_STORE_H_
...
class BlockReader {
 public:
    virtual BCACHE_ERROR ReadAt(off_t offset,
                                size_t length,
                                char* buffer) = 0;
...
#endif  // CURVEFS_SRC_CLIENT_BLOCK_CACHE_CACHE_STORE_H_
