...
#ifndef CURVEFS_SRC_CLIENT_BLOCK_CACHE_THREAD_POOL_H_
#define CURVEFS_SRC_CLIENT_BLOCK_CACHE_THREAD_POOL_H_
...
#endif  // CURVEFS_SRC_CLIENT_BLOCK_CACHE_THREAD_POOL_H_
