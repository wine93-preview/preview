...
#ifndef CURVEFS_SRC_CLIENT_BLOCK_CACHE_DISK_CACHE_H_
#define CURVEFS_SRC_CLIENT_BLOCK_CACHE_DISK_CACHE_H_
...
#include "curvefs/src/client/block_cache/disk_cache_loader.h"
...
#include "curvefs/src/client/block_cache/metric.h"
...
inline bool DiskCache::IsLoading() const { return loader_->Loading(); }

inline bool DiskCache::IsHealthy() const { return fs_->IsHealthy(); }
...
#endif  // CURVEFS_SRC_CLIENT_BLOCK_CACHE_DISK_CACHE_H_
