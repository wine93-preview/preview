...
#ifndef CURVEFS_SRC_CLIENT_BLOCK_CACHE_DISK_STATE_MACHINE_IMPL_H_
#define CURVEFS_SRC_CLIENT_BLOCK_CACHE_DISK_STATE_MACHINE_IMPL_H_
...
#endif  // CURVEFS_SRC_CLIENT_BLOCK_CACHE_DISK_STATE_MACHINE_IMPL_H_