...
TEST_F(DirEntryListTest, UpdateLength) {
  ...
  DirEntry dirEntry = MkDirEntry(
      100, "f1",
      MkAttr(100, AttrOption().length(1024).mtime(100, 101).ctime(200, 201)));
  entries.Add(dirEntry);
  ...
  {
    InodeAttr open =
        MkAttr(100, AttrOption().length(2048).mtime(100, 101).ctime(200, 202));
