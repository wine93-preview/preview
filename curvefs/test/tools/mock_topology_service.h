...
class MockTopologyService : public TopologyService {
 public:
  ...
  MOCK_METHOD4(ListPool,
               void(RpcController* controller, const ListPoolRequest* request,
                    ListPoolResponse* response, Closure* done));
  MOCK_METHOD4(CreatePool,
               void(RpcController* controller, const CreatePoolRequest* request,
                    CreatePoolResponse* response, Closure* done));
  ...
  MOCK_METHOD4(CreateZone,
               void(RpcController* controller, const CreateZoneRequest* request,
                    CreateZoneResponse* response, Closure* done));
  ...
  MOCK_METHOD4(ListMetaServer,
               void(RpcController* controller,
                    ...
                    ListMetaServerResponse* response, Closure* done));
  MOCK_METHOD4(RegistMetaServer,
               void(RpcController* controller,
                    const MetaServerRegistRequest* request,
                    MetaServerRegistResponse* response, Closure* done));
};
