...
class TestLeaderSchedule : public ::testing::Test {
 protected:
  ...
  void SetUp() override {
    ...
    leaderScheduler_ =
        std::make_shared<LeaderScheduler>(opt_, topoAdapter_, opController_);
  }
...
TEST_F(TestLeaderSchedule, test_tranferLeaderout_normal) {
  ...
  std::vector<MetaServerInfo> msInfos(
      {msInfo1, msInfo2, msInfo3, msInfo4, msInfo5, msInfo6});
...
TEST_F(TestLeaderSchedule, test_tranferLeaderout_rapid) {
  ...
  std::vector<MetaServerInfo> msInfos(
      {msInfo1, msInfo2, msInfo3, msInfo4, msInfo5, msInfo6});
  std::vector<MetaServerInfo> msInfos2(
      {msInfo1, msInfo7, msInfo8, msInfo4, msInfo5, msInfo6});
