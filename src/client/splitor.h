...
class Splitor {
 public:
  ...
  static bool NeedGetOrAllocateSegment(MetaCacheErrorType error, OpType opType,
 ...
 private:
  ...
  static bool AssignInternal(IOTracker* iotracker, MetaCache* metaCache,
                             std::vector<RequestContext*>* targetlist,
                             butil::IOBuf* data, off_t offset, uint64_t length,
                             MDSClient* mdsclient, const FInfo_t* fi,
  ...
  static bool MarkDiscardBitmap(IOTracker* iotracker, FileSegment* fileSegment,
