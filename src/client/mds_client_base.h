...
class MDSClientBase {
 public:
   ...
   * @param[in]:channel是当前与mds建立的通道
   */
  void CreateFile(const std::string& filename, const UserInfo_t& userinfo,
                  size_t size, bool normalFile, const uint64_t stripeUnit,
                  const uint64_t stripeCount, CreateFileResponse* response,
  ...
  void CreateSnapShot(const std::string& filename, const UserInfo_t& userinfo,
                      CreateSnapShotResponse* response, brpc::Controller* cntl,
                      brpc::Channel* channel);
  /**
   * 删除版本号为seq的快照
   * @param: userinfo是用户信息
   ...
   * @param[in]: channel是当前与mds建立的通道
   */
  void GetClusterInfo(GetClusterInfoResponse* response, brpc::Controller* cntl,
                      brpc::Channel* channel);
  ...
  void CreateCloneFile(const std::string& source,
                       ...
                       uint64_t stripeCount, CreateCloneFileResponse* response,
                       brpc::Controller* cntl, brpc::Channel* channel);
