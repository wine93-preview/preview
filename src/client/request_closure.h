...
class CURVE_CACHELINE_ALIGNMENT RequestClosure
 ...
 public:
   ...
   * 设置当前的IO为悬挂IO
   */
  void SetSuspendRPCFlag() { suspendRPC_ = true; }

  bool IsSuspendRPC() const { return suspendRPC_; }
...
class PaddingReadClosure : public RequestClosure {
 public:
  ...
  RequestContext* GetReqCtx() override { return alignedCtx_; }

  RequestContext* AlignedRequest() const { return alignedCtx_; }
