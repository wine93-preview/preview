  ...
  explicit ChunkServerMetric(ChunkServerIdType csId)
      : scatterWidth(kTopologyChunkServerMetricPrefix,
        ...
        chunkSizeTrashedBytes(kTopologyChunkServerMetricPrefix,
                              std::to_string(csId) + "_chunkSizeTrashedBytes",
                              0),
...
struct LogicalPoolMetric {
  ...
  explicit LogicalPoolMetric(const std::string& logicalPoolName)
      : serverNum(kTopologyLogicalPoolMetricPrefix,
        ...
        scatterWidthStandardDeviation(
            kTopologyLogicalPoolMetricPrefix,
...
struct ClusterMetric {
  const std::string kTopologyClusterMetricPrefix = "topology_metric_cluster_";
  ...
  ClusterMetric()
      : serverNum(kTopologyClusterMetricPrefix, +"server_num", 0),
        chunkServerNum(kTopologyClusterMetricPrefix, +"chunkserver_num", 0),
        copysetNum(kTopologyClusterMetricPrefix, +"copyset_num", 0),
        logicalPoolNum(kTopologyClusterMetricPrefix, +"logicalpool_num", 0),
        readRate(kTopologyClusterMetricPrefix, +"readRate", 0),
        writeRate(kTopologyClusterMetricPrefix, +"writeRate", 0),
        readIOPS(kTopologyClusterMetricPrefix, +"readIOPS", 0),
        writeIOPS(kTopologyClusterMetricPrefix, +"writeIOPS", 0),
        logicalCapacity(kTopologyClusterMetricPrefix, +"logicalCapacity", 0),
        logicalAlloc(kTopologyClusterMetricPrefix, +"logicalAlloc", 0) {}
};
...
class TopologyMetricService {
 public:
  struct ChunkServerMetricInfo {
    ...
    ChunkServerMetricInfo() : scatterWidth(0), copysetNum(0), leaderNum(0) {}
  };
