...
class TopologyServiceImpl : public TopologyService {
 public:
  ...
  void GetChunkServerInCluster(google::protobuf::RpcController* cntl_base,
  ...
  virtual void SetLogicalPool(google::protobuf::RpcController* cntl_base,
  ...
  virtual void GetCopySetsInCluster(google::protobuf::RpcController* cntl_base,
  ...
  virtual void GetClusterInfo(google::protobuf::RpcController* cntl_base,
                              const GetClusterInfoRequest* request,
                              GetClusterInfoResponse* response,
                              google::protobuf::Closure* done);

  virtual void SetCopysetsAvailFlag(google::protobuf::RpcController* cntl_base,
                                    const SetCopysetsAvailFlagRequest* request,
                                    SetCopysetsAvailFlagResponse* response,
                                    google::protobuf::Closure* done);
  virtual void ListUnAvailCopySets(google::protobuf::RpcController* cntl_base,
