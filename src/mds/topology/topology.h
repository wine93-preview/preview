...
class Topology {
 public:
  ...
  virtual int UpdateLogicalPoolScanState(PoolIdType lpid, bool scanEnable) = 0;
  ...
  virtual ChunkServerIdType FindChunkServerNotRetired(const std::string& hostIp,
                                                      uint32_t port) const = 0;

  virtual bool GetLogicalPool(PoolIdType poolId, LogicalPool* out) const = 0;
  virtual bool GetPhysicalPool(PoolIdType poolId, PhysicalPool* out) const = 0;
  ...
  virtual bool GetZone(const std::string& zoneName, PoolIdType physicalPoolId,
                       Zone* out) const = 0;
  ...
  virtual std::list<ChunkServerIdType> GetChunkServerInZone(
      ZoneIdType id, ChunkServerFilter filter = [](const ChunkServer&) {
        return true;
      }) const = 0;
  ...
  virtual std::list<PoolIdType> GetLogicalPoolInPhysicalPool(
      PoolIdType id, LogicalPoolFilter filter = [](const LogicalPool&) {
        return true;
      }) const = 0;
  ...
  virtual std::vector<CopySetKey> GetCopySetsInChunkServer(
...
class TopologyImpl : public Topology {
 public:
  ...
  int UpdateLogicalPoolScanState(PoolIdType lpid, bool scanEnable) override;
  ...
  ServerIdType FindServerByHostName(const std::string& hostName) const override;
  ...
  bool GetLogicalPool(const std::string& logicalPoolName,
    ...
    return GetLogicalPool(FindLogicalPool(logicalPoolName, physicalPoolName),
                          out);
  }
  ...
  bool GetZone(const std::string& zoneName, const std::string& physicalPoolName,
               Zone* out) const override {
    return GetZone(FindZone(zoneName, physicalPoolName), out);
  }
  bool GetZone(const std::string& zoneName, PoolIdType physicalPoolId,
               Zone* out) const override {
  ...
  bool GetChunkServerNotRetired(const std::string& hostIp, uint32_t port,
                                ChunkServer* out) const override {
  ...
  std::vector<PoolIdType> GetPhysicalPoolInCluster(PhysicalPoolFilter filter =
                                                       [](const PhysicalPool&) {
                                                         return true;
                                                       }) const override;
  ...
  std::list<ChunkServerIdType> GetChunkServerInZone(
      ZoneIdType id, ChunkServerFilter filter = [](const ChunkServer&) {
        return true;
      }) const override;
  ...
  std::list<ServerIdType> GetServerInZone(
      ZoneIdType id,
      ServerFilter filter = [](const Server&) { return true; }) const override;
  std::list<ServerIdType> GetServerInPhysicalPool(
      PoolIdType id,
      ServerFilter filter = [](const Server&) { return true; }) const override;
  std::list<ServerIdType> GetServerInLogicalPool(
      PoolIdType id,
      ServerFilter filter = [](const Server&) { return true; }) const override;

  // get zone list
  std::list<ZoneIdType> GetZoneInPhysicalPool(
      PoolIdType id,
      ZoneFilter filter = [](const Zone&) { return true; }) const override;
  std::list<ZoneIdType> GetZoneInLogicalPool(
      PoolIdType id,
      ZoneFilter filter = [](const Zone&) { return true; }) const override;

  // get logicalpool list
  std::list<PoolIdType> GetLogicalPoolInPhysicalPool(
      PoolIdType id, LogicalPoolFilter filter = [](const LogicalPool&) {
        return true;
      }) const override;
  ...
  std::vector<CopySetIdType> GetCopySetsInLogicalPool(
      PoolIdType logicalPoolId, CopySetFilter filter = [](const CopySetInfo&) {
        return true;
      }) const override;
  ...
  std::vector<CopySetKey> GetCopySetsInChunkServer(
      ChunkServerIdType id, CopySetFilter filter = [](const CopySetInfo&) {
        return true;
      }) const override;
