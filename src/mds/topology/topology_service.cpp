...
void TopologyServiceImpl::RegistChunkServer(
    ...
    ChunkServerRegistResponse* response, google::protobuf::Closure* done) {
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            ...
            << ". [ChunkServerRegistRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               ...
               << ". [ChunkServerRegistResponse] " << response->DebugString();
  } else {
...
void TopologyServiceImpl::ListChunkServer(
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [ListChunkServerRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [ListChunkServerResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [ListChunkServerResponse] " << response->DebugString();
...
void TopologyServiceImpl::GetChunkServer(
    ...
    GetChunkServerInfoResponse* response, google::protobuf::Closure* done) {
  brpc::ClosureGuard done_guard(done);
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [GetChunkServerInfoRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [GetChunkServerInfoResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [GetChunkServerInfoResponse] " << response->DebugString();
...
void TopologyServiceImpl::DeleteChunkServer(
    ...
    DeleteChunkServerResponse* response, google::protobuf::Closure* done) {
  brpc::ClosureGuard done_guard(done);
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [DeleteChunkServerRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [DeleteChunkServerResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [DeleteChunkServerResponse] " << response->DebugString();
...
void TopologyServiceImpl::SetChunkServer(
    ...
    SetChunkServerStatusResponse* response, google::protobuf::Closure* done) {
  brpc::ClosureGuard done_guard(done);
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [SetChunkServerStatusRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    ...
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [SetChunkServerStatusResponse] " << response->DebugString();
  }
}
...
void TopologyServiceImpl::ListPhysicalPool(
    google::protobuf::RpcController* cntl_base,
    const ListPhysicalPoolRequest* request, ListPhysicalPoolResponse* response,
    google::protobuf::Closure* done) {
  brpc::ClosureGuard done_guard(done);
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [ListPhysicalPoolRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [ListPhysicalPoolResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [ListPhysicalPoolResponse] " << response->DebugString();
...
void TopologyServiceImpl::CreateLogicalPool(
    ...
    CreateLogicalPoolResponse* response, google::protobuf::Closure* done) {
  brpc::ClosureGuard done_guard(done);
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [CreateLogicalPoolRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [CreateLogicalPoolResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [CreateLogicalPoolResponse] " << response->DebugString();
...
void TopologyServiceImpl::DeleteLogicalPool(
    ...
    DeleteLogicalPoolResponse* response, google::protobuf::Closure* done) {
  brpc::ClosureGuard done_guard(done);
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [DeleteLogicalPoolRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [DeleteLogicalPoolResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [DeleteLogicalPoolResponse] " << response->DebugString();
...
void TopologyServiceImpl::GetLogicalPool(
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [GetLogicalPoolRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [GetLogicalPoolResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [GetLogicalPoolResponse] " << response->DebugString();
...
void TopologyServiceImpl::ListLogicalPool(
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [ListLogicalPoolRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [ListLogicalPoolResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [ListLogicalPoolResponse] " << response->DebugString();
...
void TopologyServiceImpl::SetLogicalPool(
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [SetLogicalPoolRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [SetLogicalPoolResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [SetLogicalPoolResponse] " << response->DebugString();
...
void TopologyServiceImpl::SetLogicalPoolScanState(
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << remoteAddr << " to " << localAddr
            << ". [SetLogicalPoolScanStateRequest] " << request->DebugString();

  topology_->SetLogicalPoolScanState(request, response);

  std::ostringstream errMsg;
  errMsg << "Send response[log_id=" << cntl->log_id() << "] from " << localAddr
         << " to " << remoteAddr << ". [SetLogicalPoolScanStateResponse] "
         << response->DebugString();
...
void TopologyServiceImpl::GetCopySetsInChunkServer(
  ...
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [GetCopySetsInChunkServerRequest] " << request->DebugString();
...
void TopologyServiceImpl::GetCopySetsInCluster(
    ...
    GetCopySetsInClusterResponse* response, google::protobuf::Closure* done) {
  brpc::ClosureGuard done_guard(done);
  brpc::Controller* cntl = static_cast<brpc::Controller*>(cntl_base);
  ...
  auto remoteAddr = cntl->remote_side();
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << remoteAddr << " to " << localAddr << ". [GetCopySetsInCluster] "
            << request->DebugString();
  ...
  std::ostringstream errMsg;
  errMsg << "Send response[log_id=" << cntl->log_id() << "] from " << localAddr
         << " to " << remoteAddr << ". [GetCopySetsInCluster] "
         << response->DebugString();
...
void TopologyServiceImpl::GetCopyset(google::protobuf::RpcController* cntl_base,
  ...
  auto remoteAddr = cntl->remote_side();
  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << remoteAddr << " to " << localAddr << ". [GetCopyset] "
            << request->DebugString();
...
void TopologyServiceImpl::GetClusterInfo(
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [GetClusterInfoResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [GetClusterInfoResponse] " << response->DebugString();
...
void TopologyServiceImpl::SetCopysetsAvailFlag(
    ...
    SetCopysetsAvailFlagResponse* response, google::protobuf::Closure* done) {
  brpc::ClosureGuard done_guard(done);
  brpc::Controller* cntl = static_cast<brpc::Controller*>(cntl_base);

  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [SetCopysetsAvailFlagRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    ...
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [SetCopysetsAvailFlagResponse] " << response->DebugString();
  }
}
...
void TopologyServiceImpl::ListUnAvailCopySets(
    ...
    ListUnAvailCopySetsResponse* response, google::protobuf::Closure* done) {
  brpc::ClosureGuard done_guard(done);
  brpc::Controller* cntl = static_cast<brpc::Controller*>(cntl_base);

  LOG(INFO) << "Received request[log_id=" << cntl->log_id() << "] from "
            << cntl->remote_side() << " to " << cntl->local_side()
            << ". [ListUnAvailCopySetsRequest] " << request->DebugString();
  ...
  if (kTopoErrCodeSuccess != response->statuscode()) {
    LOG(ERROR) << "Send response[log_id=" << cntl->log_id() << "] from "
               << cntl->local_side() << " to " << cntl->remote_side()
               << ". [ListUnAvailCopySetsResponse] " << response->DebugString();
  } else {
    LOG(INFO) << "Send response[log_id=" << cntl->log_id() << "] from "
              << cntl->local_side() << " to " << cntl->remote_side()
              << ". [ListUnAvailCopySetsResponse] " << response->DebugString();
