...
class FileRecord {
 public:
   ...
   */
  std::string GetClientVersion() const { return clientVersion_; }

  butil::EndPoint GetClientEndPoint() const { return endPoint_; }
...
class FileRecordManager {
 public:
   ...
   * @param[in] filename
   */
  bool GetMinimumFileClientVersion(const std::string& fileName,
