...
class FileReadLockGuard {
 public:
   ...
   */
  FileReadLockGuard(FileLockManager* fileLockManager, const std::string& path);
...
class FileWriteLockGuard {
 public:
   ...
   * @param path the path on which the lock applied
   */
  FileWriteLockGuard(FileLockManager* fileLockManager, const std::string& path);
   ...
   * @param path2
   */
  FileWriteLockGuard(FileLockManager* fileLockManager, const std::string& path1,
