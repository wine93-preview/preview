...
void FileLockManager::LockInternal(const std::string& path, LockType lockType) {
...
FileReadLockGuard::~FileReadLockGuard() { fileLockManager_->Unlock(path_); }
...
// this interface is for locking newfile and oldfile at the same time when
// renaming //NOLINT
FileWriteLockGuard::FileWriteLockGuard(FileLockManager* fileLockManager,
