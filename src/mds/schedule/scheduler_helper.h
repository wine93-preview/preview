...
class SchedulerHelper {
 public:
  ...
  /**
   * @brief SortDistribute Sort chunkservers by copyset number in descending
   * order //NOLINT
   *
  ...
  static void SortDistribute(
      ...
      std::vector<std::pair<ChunkServerIdType, std::vector<CopySetInfo>>>*
          desc);

  /**
   * @brief SortScatterWitAffected Sort the input by the sum of the
   *                               scatter-width difference (the value of the
   * pair of the input) //NOLINT
   *
   * @param[in] candidates
   */
  ...
  /**
   * @brief SortChunkServerByCopySetNumAsc Rank chunkserver by the number of the
   * copyset //NOLINT
   *
   ...
   * @param[out] out List of copyset on chunkserver
   */
  static void FilterCopySetDistributions(
