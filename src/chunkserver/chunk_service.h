...
class ChunkServiceImpl : public ChunkService {
 public:
  ...
  void ReadChunkSnapshot(RpcController* controller, const ChunkRequest* request,
                         ChunkResponse* response, Closure* done);
  ...
  void CreateCloneChunk(RpcController* controller, const ChunkRequest* request,
                        ChunkResponse* response, Closure* done);
  ...
  void UpdateEpoch(RpcController* controller, const UpdateEpochRequest* request,
