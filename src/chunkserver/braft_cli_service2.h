...
class BRaftCliServiceImpl2 : public CliService2 {
 public:
  // @brief: Add a peer.
  void AddPeer(RpcController* controller, const AddPeerRequest2* request,
               AddPeerResponse2* response, Closure* done);

  // @brief: Remove peer.
  void RemovePeer(RpcController* controller, const RemovePeerRequest2* request,
  ...
  void ChangePeers(RpcController* controller,
                   ...
                   ChangePeersResponse2* response, Closure* done);

  // @brief: Get the leader of copyset.
  void GetLeader(RpcController* controller, const GetLeaderRequest2* request,
  ...
  void ResetPeer(RpcController* controller, const ResetPeerRequest2* request,
                 ResetPeerResponse2* response, Closure* done);

  // @brief: Trigger snapshot.
  void Snapshot(RpcController* controller, const SnapshotRequest2* request,
   ...
   */
  void SnapshotAll(RpcController* controller, const SnapshotAllRequest* request,
