...
class DeleteChunkRequest : public ChunkOpRequest {
 public:
  ...
  DeleteChunkRequest(std::shared_ptr<CopysetNode> nodePtr, RpcController* cntl,
                     const ChunkRequest* request, ChunkResponse* response,
                     ::google::protobuf::Closure* done)
...
class ReadChunkRequest : public ChunkOpRequest {
 ...
 public:
  ...
  ReadChunkRequest(std::shared_ptr<CopysetNode> nodePtr, CloneManager* cloneMgr,
...
class ReadSnapshotRequest : public ChunkOpRequest {
 public:
  ...
  ReadSnapshotRequest(std::shared_ptr<CopysetNode> nodePtr, RpcController* cntl,
                      const ChunkRequest* request, ChunkResponse* response,
                      ::google::protobuf::Closure* done)
      : ChunkOpRequest(nodePtr, cntl, request, response, done) {}
