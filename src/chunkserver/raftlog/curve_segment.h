...
class BAIDU_CACHELINE_ALIGNMENT CurveSegment : public Segment {
 public:
  ...
  int64_t bytes() const override { return _meta.bytes; }

  int64_t first_index() const override { return _first_index; }
