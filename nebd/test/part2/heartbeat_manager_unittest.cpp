...
TEST_F(HeartbeatManagerTest, CheckTimeoutTest) {
  ...
  std::shared_ptr<MockFileEntity> entity1 = std::make_shared<MockFileEntity>();
  std::shared_ptr<MockFileEntity> entity2 = std::make_shared<MockFileEntity>();
  std::shared_ptr<MockFileEntity> entity3 = std::make_shared<MockFileEntity>();
